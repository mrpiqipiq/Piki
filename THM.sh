...
sleep 0.4;
echo  $blue
echo "........... welcome to tool Mr.piqipiq........";
sleep 0.1;
clear
echo
echo
...
echo $yellow
figlet -f future "Team_hack_mayang"
echo
echo $red"##########################$green" WELCOME "$red###########################"
echo
...
echo $indigo"=============================================================="
echo
echo $white "╭─"$yellow"Mr.piqipiq"$cyan" ~/Team_Mayang"$white
read -p " ╰─$ "  apaan
echo
if [ $apaan = "A" ] || [ $apaan = "a" ]
then
...
echo $green "╭─"$blue"Mr.piqipiq"$cyan" ~/Team_Mayang"$white
read -p " ╰─$ "  target
echo
echo $red "Masukan Script!!! "
echo $green "╭─"$blue"Mr.piqipiq"$cyan" ~/Nama SC Harus(index.html)"$white
read -p " ╰─$ "  script
...
echo
echo "Masukan Script !!!!"
echo $white "╭─"$green"Mr.piqipiq"$cyan" ~/Team_Mayang"$white                               
read -p " ╰─$ " script
echo
echo
echo $white"Masukan Target1 !!!!"
echo $white "╭─"$green"Mr.piqipiq"$cyan" ~/Crot"$white
read -p " ╰─$ " target1
...
echo $red"##########################$green" WELCOME "$red###########################"
echo $green"Author  : Mr.Piqipiq			"
echo $blue"Facebook   : ?_?"
echo
echo $yellow"                          THANKS TO :"
echo
echo $cyan"[+] Mr.piqipiq & All Member [T.H.M] "
echo $red"##########################$green" WELCOME "$red###########################"
